...
const SignUp = () => {
    ...
    let signInError;
    const [token] = useTools(user || gUser);
    ...
    return (
        <div className='flex h-screen justify-center items-center mb-7'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="text-center text-2xl text-secondary font-bold">SignUp Now</h2>
